...
from backend.schemas.attack_path_schemas import AttackNode, AttackPath, NodeType, STRIDECategory
...
def test_neo4j_parameterised_queries():
    ...
    import backend.attack_path.graph_builder as graph_builder_mod
