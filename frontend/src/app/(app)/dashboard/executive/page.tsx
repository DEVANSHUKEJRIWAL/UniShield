...
export default function ExecutiveDashboardPage() {
  ...
  return (
    <>
      <AdminPageHeader title="Executive" subtitle="Board-level risk trend and critical summary" />

      <div className="ac-grid-2">
        <AnimatedCard>
          <h2 className="ac-section-title">Risk Trend</h2>
            ...
            {(data.risk_trend ?? [
              ...
              <div key={p.date} className="flex items-center gap-3">
                ...
                <span className="font-mono text-xs">
                  <CountUp end={Math.round(p.score * 100)} />%
                </span>
              </div>
            ))}
          </div>
        ...
        <AnimatedCard delay={0.1}>
          <h2 className="ac-section-title">Critical Summary</h2>
